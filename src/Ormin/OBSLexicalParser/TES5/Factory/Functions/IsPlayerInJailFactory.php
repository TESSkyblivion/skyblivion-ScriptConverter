...
class IsPlayerInJailFactory implements FunctionFactory
{
    ...
    public function convertFunction(TES5Referencer $calledOn, TES4Function $function, TES5CodeScope $codeScope, TES5GlobalScope $globalScope, TES5MultipleScriptsScope $multipleScriptsScope)
    {
        ...
        return $this->objectPropertyFactory->createObjectProperty($multipleScriptsScope, $this->referenceFactory->createReadReference("tContainer", $globalScope, $multipleScriptsScope, $localScope), "isInJail");
    }
}