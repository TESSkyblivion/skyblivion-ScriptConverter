...
class ResurrectFactory implements FunctionFactory
{
    /**
    ...
    {
        return $this->objectCallFactory->createObjectCall($calledOn, "Resurrect", $multipleScriptsScope, new TES5ObjectCallArguments());
    }
}