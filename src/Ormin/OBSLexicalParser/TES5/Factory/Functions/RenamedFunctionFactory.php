 ...
 */
class RenamedFunctionFactory implements FunctionFactory
{
    ...
    public function __construct($newFunctionName, TES5ObjectCallFactory $objectCallFactory, TES5ObjectCallArgumentsFactory $objectCallArgumentsFactory)
    {
