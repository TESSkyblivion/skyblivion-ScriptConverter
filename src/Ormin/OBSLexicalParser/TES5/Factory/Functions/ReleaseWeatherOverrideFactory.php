...
class ReleaseWeatherOverrideFactory implements FunctionFactory
{
    /**
    ...
    {
        return $this->objectCallFactory->createObjectCall($this->referenceFactory->createReferenceToStaticClass("Weather"), "ReleaseOverride", $multipleScriptsScope, new TES5ObjectCallArguments());
    }
}