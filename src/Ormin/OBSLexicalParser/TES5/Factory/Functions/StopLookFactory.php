...
class StopLookFactory implements FunctionFactory
{
    ...
    {
        return $this->objectCallFactory->createObjectCall($calledOn, "ClearLookAt", $multipleScriptsScope, new TES5ObjectCallArguments());
